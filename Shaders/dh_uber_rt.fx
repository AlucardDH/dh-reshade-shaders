...
// Define if the ray tracing should stop when a surface is almost hit, and after how many retries
// Default is 0 (no premature stop), 1 for 1 try, 2 for 2 tries... generaly, 8 is equivalent to 0
